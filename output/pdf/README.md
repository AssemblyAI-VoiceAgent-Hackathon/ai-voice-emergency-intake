...
Current Discord review document: `AI_Emergency_Intake_Team_Workflow_Roles_v3.pdf`.

- Keep the v3 filename and the original landscape layout, role colours, swimlanes, section order and step references.
...
- The current v3 document must retain the confirmed names: Shahzaib Fraz, Fazwan Zainuddin, Mozzam Shahid, Ishaan Sama, Jonathan and Mariam Habib.
...
- Publish the current document as `AI_Emergency_Intake_Team_Workflow_Roles_v3.pdf`; preserve earlier or user-edited copies in `archive/`.
...
Current revision: v3, 1 September 2026. The original four pages are retained with targeted SSE/handoff edits, followed by the team-status page and a confirmed-roles/Ishaan-contribution page.
